...
ActiveRecord::Schema.define(version: 2019_05_28_032550) do
  ...
  create_table "studio_types_studios", force: :cascade do |t|
    t.integer "studio_type_id"
    t.integer "studio_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["studio_id"], name: "index_studio_types_studios_on_studio_id"
    t.index ["studio_type_id"], name: "index_studio_types_studios_on_studio_type_id"
  end
  ...
  create_table "studios", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id_id"], name: "index_studios_on_user_id_id"
  end
